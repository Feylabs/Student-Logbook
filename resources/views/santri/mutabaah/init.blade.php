                            ...
                            <tbody>
                                @forelse ($widget['mutabaah'] as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->status == 1)
                                                <button type="button" class="btn btn-success disabled mr-4">Status :
                                                    Dibuka</button>
                                                <a href="{{ route('santri.mutabaah.input', $item->id) }}">
                                                    <button type="button" class="btn btn-outline-primary">Isi Lembar
                                                        Mutaba'ah</button>
                                                </a>
                                            @endif

                                            @if ($item->status == 0)
                                                <button type="button" class="btn btn-danger disabled mr-4">Status :
                                                    Ditutup</button>
                                                <a href="{{ route('santri.mutabaah.input', $item->id) }}">
